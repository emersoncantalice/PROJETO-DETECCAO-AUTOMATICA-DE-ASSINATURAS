...
public class SimpleBorderFilter{
        ...
        public GrayF32 apply( GrayF32 input, GrayF32 output){
        ...
        private boolean clearLine(GrayF32 input, GrayF32 output , int current, boolean horizontal){
            int last = 0;
            int count = 0;
            boolean found = false;
            float value = 0;
        ...
        private void clear( GrayF32 output , int start, int end , int current, boolean horizontal) {
            // System.out.println("\nClear: (" + start + "," + end + ")");
            if(horizontal){
                for (; start < end; start++) {
